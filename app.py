...
df = pd.read_csv(r"C:\Users\patil_jdjp1db\Downloads\Diabetes-Prediction-Web-App-main\diabetes.csv")
...
def user_report():
  ...
  bp = st.sidebar.slider('BloodPressure (mm/Hg)', 0,122, 70 )
  skinthickness = st.sidebar.slider('SkinThickness (mm)', 0,100, 20 )
  insulin = st.sidebar.slider('Insulin (pmol/L)', 0,846, 79 )
  bmi = st.sidebar.slider('BMI (kg/m^2)', 0,67, 20 )
  dpf = st.sidebar.slider('DiabetesPedigreeFunction (generation)', 0.0,2.4, 0.47 )
